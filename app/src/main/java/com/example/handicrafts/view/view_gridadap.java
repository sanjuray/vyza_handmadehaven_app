...
//same as list view adapter

public class view_gridadap extends BaseAdapter {
    Context context;
    ArrayList<view_data> item_list;

    public view_gridadap(Context context, ArrayList<view_data> item_list) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        view_data currentItem = item_list.get(i);
