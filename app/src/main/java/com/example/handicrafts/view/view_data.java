...
public class view_data {
    ...
    public view_data(String product_id, String images, String name, String price, String discount, String description, String content_review, String state, String city, int fav, int discount_logo) {
