...
public class models {
        ...
        public models(String product_id, String images, String name, String price, String discount, String description, String content_review, String state, String city, int fav, int discount_logo) {
